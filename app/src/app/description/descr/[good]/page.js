...
function  Description() {
    ...
    <div  className={styles.sliderStyles}>
                    <div  className={styles.slideStyles} >
                          <img className={styles.sl_img} width={1500} height={750}  src={slides[parentData][currentIndex]}/>
                          <div  className={styles.arrows} >
                          <img onClick={goToPrevios} className={styles.leftArrowStyles} height={32} width={32} src="/rarrow.png"  alt="" />
                        <img className={styles.rightArrowStyles} onClick={goToNext} height={32} width={32} src="/larrow.png" alt="" />
                        </div> 
                    </div>
                    
                    <div  className={styles.dotsContainer}>
              {slides[parentData].map((item,slideIndex)=><img src={item} width={100} height={70} onClick={() => goToSlide(slideIndex)} 
    ...
    <div className={styles.rigth_side}>
        ...
        <p className={styles.descr}> {text1}
       ...
       <Link onClick={() => addCartItem(good)} href="/cart"> <button className={styles.button} >ПРИДБАТИ</button> </Link>
       </div>
       </div>
    </div>
